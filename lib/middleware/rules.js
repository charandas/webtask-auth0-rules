 ...
 */
function upsertExistingInvalid (rulesContext, opts) {
  let clientId;
  let clientName;
 ...
 */
function upsertExisting (rulesContext, opts) {
  let clientId;
  let clientName;
...
function reduceClientAndRules (rulesContext, reportInvalidsOnly) {
  ...
  const upsertFn = reportInvalidsOnly ? upsertExistingInvalid : upsertExisting;
